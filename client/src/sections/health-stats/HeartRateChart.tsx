...
const HeartRateChart = ({ selectedMemberId, selectedStatType, date }: GetHealthStatsParams) => {
    ...
    <div>
      ...
      <ResponsiveContainer width="100%" height={400}>
        ...
        >
          ...
          />
          <YAxis yAxisId="left" label={{ value: 'Heart rate (npm)', angle: -90, position: 'insideLeft' }} />
          <Tooltip />
