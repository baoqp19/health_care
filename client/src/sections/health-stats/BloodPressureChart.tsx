...
import { GetHealthStatsParams, useToDisplayChart } from '../../api/health-stats/get-to-display-chart';


const BloodPressureChart = ({ selectedMemberId, selectedStatType, date }: GetHealthStatsParams) => {
        ...
        <div>
            ...
            <ResponsiveContainer width="100%" height={400}>
                ...
                >
                    ...
                    />
                    <YAxis yAxisId="left" label={{ value: 'Blood Pressure (mmHg)', angle: -90, position: 'insideLeft' }} />
                    <Tooltip />
