...
interface SupportRequestFormProps {
    ...
    handleSendSupportRequest: () => void;
}


const SupportRequestForm: React.FC<SupportRequestFormProps> = ({ supportRequest, setSupportRequest, handleSendSupportRequest }) => (
...
const HelpPage = () => {
    ...
    const handleSendSupportRequest = async () => {
        try {
            ...
            message.error(<span><ExclamationCircleOutlined /> Đã có lỗi xảy ra: {(error as Error).message}</span>);
        }
    };
